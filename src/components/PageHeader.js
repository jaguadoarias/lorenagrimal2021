...
const PageHeader = ({
  ...
  return (
    <div className={`PageHeader relative ${className} ${align}`}>
      {backgroundImage && (
        <Image
          background
          resolutions="large"
